...
- Добавлен HorizontalPager с вкладками INFO, META, STRING, XML и ASSETS:
  - Плавная анимация при переключении табов
  - Синхронизация состояния табов с пейджером
  - Поддержка свайпов для переключения экранов
...
- Добавлен AssetsScreen для просмотра ассетов приложения:
  - Отображение списка ассетов
  - Копирование имени и содержимого ассета
  - Поддержка поделиться ассетом
  - Отображение содержимого текстовых ассетов
...
- Исправлена синхронизация между табами и контентом
...
## Исправления багов:
- Исправлен AssetsScreen: правильные типы данных (ResItem вместо StringItemViewModel)
- Исправлен вызов загрузки ассетов (loadManifestContent вместо loadResourceContent)
- Добавлено корректное отображение содержимого ассетов 

## Улучшение архитектуры:
- Добавлен AssetsViewModel для управления состоянием и действиями на экране ассетов
- Реализован MVVM паттерн для AssetsScreen
- Добавлена обработка разрешений для сохранения и экспорта иконок
- Реализовано сохранение состояния при повороте экрана через ViewModel

## Улучшение интерфейса:
- Добавлено главное меню в ExtractorScreen:
...
- Добавлены иконки для всех пунктов меню
- Реализованы все действия меню с корректной обработкой ошибок
- Улучшен UX с использованием Material3 DropdownMenu
- Добавлено меню действий для каждого ассета
- Реализован просмотр содержимого текстовых ассетов
- Добавлено копирование имени и содержимого ассета
- Реализовано сохранение и экспорт иконок
- Добавлена возможность архивации всех ассетов
- Улучшен UI с использованием Material3
- Добавлены иконки для папок и изображений
- Добавлен диалог About:
  * Отображение названия приложения
  * Версия приложения
  * Копирайт
  * Material3 дизайн с иконкой
  * Анимация появления/скрытия

## Исправления багов:
- Исправлено использование неправильных типов данных в AssetsScreen
- Добавлена корректная обработка разрешений для сохранения файлов
- Исправлено отображение содержимого ассетов
- Реализована правильная очистка состояния при закрытии диалогов 