...
import com.walhalla.appextractor.utils.IntentUtils.openSettingsForPackageName
...
//        }firebase_url app_name
        try {
            ...
            data.add(
                HeaderObject(
                    context.getString(R.string.title_strings),
    ...
    private fun wrapV2Line(key: String, value: String): ViewModel {
    ...
    private fun meta7(data: MutableList<ViewModel>) {
        //    <activity>*
//    <activity-alias>
//    <application>*
//    <provider>*
...
//                            R.drawable.ic_category_activity));
    ...
    fun openSettingsRequest(context: Context) {
        if (!TextUtils.isEmpty(packageInfo!!.packageName)) {
            //app info
            openSettingsForPackageName(context, packageInfo!!.packageName)
        }
    }
    ...
    fun onLaunchExportedService(class_name: String) {
        ...
        try {
            ...
            exception = e
            d("[1," + packageInfo!!.packageName + "::" + class_name + DEVIDER_END + exception.localizedMessage)
            ...
            try {
                ...
                exception = e0
                d("[2," + packageInfo!!.packageName + "::" + class_name + DEVIDER_END + e0.localizedMessage)
            }
        }
        if (exception != null) {
    ...
    companion object {
        ...
        init {
            map["applovin."] = R.drawable.ic_applovin
            map["com.google.firebase."] = R.drawable.ic_firebase
            map["com.unity3d."] =
                R.drawable.ic_unity3d
            map["com.facebook."] =
