...
public class MimeTabAdapter extends RecyclerView.Adapter<MimeTabAdapter.MimeViewHolder> {
    ...
    public static final HashSet<String> ALL_ACTIONS = new HashSet<String>() {
        {
...
//            add(Intent.ACTION_WINDOW_CONFIGURATION_CHANGED);
    ...
    static class MimeViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindRecyclerView(String mimeType) {
            List<ResolveInfo> activityList = getServices(ALL_ACTIONS, itemView.getContext());
           if(activityList!=null){
               mAdapter.setActivityList(activityList);
           }
        }

        public static List<ResolveInfo> getServices(HashSet<String> actions, Context context) {
