...
public class DebugPagerFr2 extends BaseFragment
    ...
    private HashMap<Integer, List<PackageMeta>> mm;
    private ViewpagerAdapter adapter;
    private HashMap<Integer, Integer> keyIndex;

    public DebugPagerFr2() {
...
//    }
    ...
    public static DebugPagerFr2 newInstance() {
        return new DebugPagerFr2();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            for (Map.Entry<Integer, List<PackageMeta>> entry : mm.entrySet()) {

                Integer key = entry.getKey();
                String label = String.valueOf(ApplicationInfo.getCategoryTitle(getContext(), key));
        ...
        viewPager.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                Integer key = keyIndex.get(position);
...
//                });
    ...
    private HashMap<Integer, List<PackageMeta>> test1() {
        HashMap<Integer, List<PackageMeta>> map = new HashMap<>();
...
//            meta.size = size;
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                List<PackageMeta> metaList = map.get(applicationInfo.category);
                if (metaList == null) {
                    metaList = new ArrayList<>();
                }
                metaList.add(meta);
                map.put(applicationInfo.category, metaList);
            }
        }
        return map;
    }

    public final static class ViewpagerAdapter extends FragmentStateAdapter {
