...
//import com.walhalla.appextractor.adapter.FilesAdapter;
//import com.walhalla.appextractor.task.UploadFileTask;
//import com.walhalla.db.DownloadFileTask;
//import com.walhalla.db.DropboxClientFactory;
//import com.walhalla.db.ListFolderTask;
//import com.walhalla.db.PicassoClient;
//
//import java.io.File;
...
//        fab.setOnClickListener(v -> performWithPermissions(FileAction.UPLOAD));
//        //init picaso client
...
//                String aaa = data.getData().toString();
//                uploadFile(aaa);
//            }
//        }
//    }
...
//        super.onRequestPermissionsResult(actionCode, permissions, grantResults);
//
...
//
//            @Override
//            public void onUploadComplete(List<FileMetadata> results) {
//                dialog.dismiss();
//                FileMetadata result = results.get(0);
...
//
//            @Override
//            public void progressUpdate(Integer[] progress, File localFile, String fileSize) {
//
//            }
//        }).execute(new String[]{fileUri}/*, mPath*/);
//    }
//
...
//                    .setPositiveButton(android.R.string.ok, (dialog, which) -> requestPermissionsForAction(action))
